...
public class SafepointDetailsFragment extends Fragment implements OnStreetViewPanoramaReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, GooglePlacesHelper.PlacesHelperListener {
    ...
    private void getSafepointById(String safepointId) {
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                Safepoint safepoint = dataSnapshot.getValue(Safepoint.class);
                safepoint.setUid(dataSnapshot.getKey());
                onSafepointFetched(safepoint);
            }
    ...
    private void onSafepointFetched(Safepoint safepoint) {
    ...
    @Override
    public void onPlaceFound(final Place place, final Safepoint safepoint) {
        Toolbar toolbar = (Toolbar) getActivity().findViewById(R.id.toolbar);
        toolbar.setTitle(safepoint.getCategory());

        androidGridView = (GridView) getView().findViewById(R.id.gridview_details);
        androidGridView.setAdapter(new ImageAdapterGridView(getActivity(), safepoint.getUtilitiesImages()));
        ...
        mStreetViewPanorama.setOnStreetViewPanoramaChangeListener(new StreetViewPanorama.OnStreetViewPanoramaChangeListener() {
            ...
            public void onStreetViewPanoramaChange(StreetViewPanoramaLocation streetViewPanoramaLocation) {
                if (streetViewPanoramaLocation != null && streetViewPanoramaLocation.links != null) {
                    Log.i("Panorama set succes", safepoint.toString());
